...
function recursiveSensor(){
  getSensorData();
  setTimeout('recursiveSensor()', 5000);
}
    ...
    if(xmlHttp.status==200){
        ...
        if(document.getElementById('indexIframe').contentWindow.document.getElementsByTagName("body")[0].id == "homeBody"){ //Checks iframe body id against Home body id
          if(co2<500 && monitor_state != 1){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/1.svg"; monitor_state=1;}
          else if(co2>=500 && co2<700 && monitor_state != 2){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/2.svg"; monitor_state=2;}
          else if(co2>=700 && co2<900 && monitor_state != 3){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/3.svg"; monitor_state=3;}
          else if(co2>=900 && co2<1100 && monitor_state != 4){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/4.svg"; monitor_state=4;}
          else if(co2>=1100 && co2<1300 && monitor_state != 5){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/5.svg"; monitor_state=5;}
          else if(co2>=1300 && co2<1700 && monitor_state != 6){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/6.svg"; monitor_state=6;}
          else if(co2>=1700 && co2<2500 && monitor_state != 7){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/7.svg"; monitor_state=7;}
          else if(co2>=2500 && co2<5000 && monitor_state != 8){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/mascot/8.svg"; monitor_state=8;}
          else if(co2>=5000 && monitor_state != 9){
            document.getElementById('indexIframe').contentWindow.document.getElementById("Robert").src="./img/blue.png"; monitor_state=9;}
